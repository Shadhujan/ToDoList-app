    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (singleTask.get("status").contentEquals("1")) {
                String htmlString = "<strike>" + singleTask.get("task") + "</strike>";
                holder.task_name.setText(HtmlCompat.fromHtml(htmlString, HtmlCompat.FROM_HTML_MODE_LEGACY));
            ...
            holder.checkBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        tmpHolder.task_name.setText(HtmlCompat.fromHtml("<strike>" + singleTask.get("task") + "</strike>", HtmlCompat.FROM_HTML_MODE_LEGACY));                    } else {
